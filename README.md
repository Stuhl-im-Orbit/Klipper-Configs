...
A compact open-frame cartesian printer from Rat Rig with a 180 mm³ build volume. Two units in the fleet — Orange and Yellow — each with slightly different electronics but sharing the same mechanical platform and sensorless homing setup.
